        ...
        <div class="p-5 bg-white shadow-sm rounded">
            <div class="row g-4">
                <div class="col-12 text-center">
                    ...
                    <p class="text-muted mb-4">We're here to answer any questions about skincare, product details, or collaborations!</p>
                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <form method="POST" action="{{ route('contact') }}" class="contact-form">
                        @csrf
                        <input type="text" name="name" class="form-control py-3 mb-4" placeholder="Your Name" required>
                        <input type="email" name="email" class="form-control py-3 mb-4" placeholder="Your Email" required>
