...
@section('content')
    <div class="container my-4">
        <div class="d-flex align-items-center mb-4">
            <div class="me-auto">
                <h4 class="fw-bold mb-0">Update Order <span
                        class="text-pink">SKINTIFIX-{{ str_pad($order->id, 5, '0', STR_PAD_LEFT) }}</span>
                    <span
                        class="badge 
                @if ($order->status == 'pending') text-secondary border border-secondary
                @elseif($order->status == 'processing') text-warning border border-warning
                @elseif($order->status == 'completed') text-success border border-success
                @else text-secondary border border-secondary @endif
