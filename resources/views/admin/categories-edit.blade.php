    ...
    <div class="container my-4">
        <div class="row mb-4">
            <div class="col-12">
                ...
                <p class="text-muted m-0">Modify category details to keep your store organized</p>
            </div>
        </div>
                        ...
                        <form action="{{ route('categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                                    placeholder="Brief description of the category" required>{{ old('description', $category->description) }}</textarea>
                                @error('description')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
