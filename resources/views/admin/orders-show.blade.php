...
@section('content')
    <div class="container my-4">
        <h1>TEST PAGE - ADMIN ORDER SHOW</h1>
        ...
        <div class="row">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-4">
                            Placed on {{ \Carbon\Carbon::parse($order->order_date)->format('d F Y') }} |
                            SKINTIFIX-{{ str_pad($order->id, 5, '0', STR_PAD_LEFT) }}
                        </p>
                                    ...
                                    <tr class="align-middle">
                                        <td>
                                            <img src="{{ Str::startsWith($item->product->image, ['http://', 'https://']) ? $item->product->image : asset($item->product->image) }}"
                                                alt="{{ $item->product->name }}" class="img-fluid" style="height: 70px;">
                                        </td>
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <p class="mb-0 fw-bold">{{ $order->recipient_name }}</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Status:</strong>
                            ...
                            @elseif (isset($order->payment) && $order->payment->payment_status == 'pending')
                                <span class="badge rounded-pill border border-secondary text-secondary">Pending</span>
                            @elseif (isset($order->payment) && $order->payment->payment_status == 'failed')
                        ...
                        <p class="mb-0"><strong>Amount:</strong> Rp
