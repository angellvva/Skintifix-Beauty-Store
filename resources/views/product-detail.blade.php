...
<div class="product-section">
    <div class="container mt-5">
        ...
        <!-- Product Info Card -->
        <div class="white-container position-relative mb-5" style="background-color: white; padding: 40px 30px 30px 30px; border-radius: 16px;">
        ...
        <div class="white-container p-4" style="background-color: white; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
